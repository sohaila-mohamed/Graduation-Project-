        ...
        this.platform.ready().then(() => {
            ...
            this.datastore.isTokenExpired().then((isTokenExpired) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                ...
                if (!isTokenExpired) {
                    ...
                    yield this.datastore.getMyPatientData().then((patient) => {
                        that.datastream.SetPatientforLogin(patient);
                        this.myName = this.datastream.getPatientName();
                        console.log("menu name", this.myName);
                    });
                    yield this.datastore.getPatientToken().then((token) => {
                        that.datastream.setToken(token);
                    });
                    yield this.datastore.getDoctorList().then((doctorList) => {
...
let HttpService = class HttpService {
    ...
    createPatient(newPatient) {
        ...
        return this.http.post(url, newPatient, this.httpOptions);
        // .toPromise()
        // .then(data => {
        //   console.log("da5lr")
        //   console.log(data);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MyPatient", function() { return MyPatient; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
let DatastorageService = class DatastorageService {
    ...
    isTokenExpired() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            let that = this;
            yield this.getPatientToken().then(token => {
                if (token != null) {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_model_patientData__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/model/patientData */ "./src/app/model/patientData.ts");
/* harmony import */ var _datastorage_datastorage_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../datastorage/datastorage.service */ "./src/app/services/datastorage/datastorage.service.ts");
/* harmony import */ var src_app_model_doctorData__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/model/doctorData */ "./src/app/model/doctorData.ts");
...
let DatastreamingService = class DatastreamingService {
    ...
    restoreStreamDatalist(doctorList) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            (yield doctorList).forEach(element => {
...
DatastreamingService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_datastorage_datastorage_service__WEBPACK_IMPORTED_MODULE_3__["DatastorageService"]])
...
module.exports = __webpack_require__(/*! /home/habiba/GP/Graduation-Project-/Patient/src/main.ts */"./src/main.ts");
