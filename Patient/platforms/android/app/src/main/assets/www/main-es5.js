(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".grad {\n  --background: linear-gradient(\n  to bottom,\n  #0a5279 0%,\n  #80d3cb 100%) ;\n}\n\n.opp {\n  opacity: 0.6;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.next = 5;
                  return this.datastore.getMyPatientData().then(patient => {
                ...
                case 5:
                  _context.next = 7;
                  return this.datastore.getPatientToken().then(token => {
                    that.datastream.setToken(token);
                  });

                case 7:
                  _context.next = 9;
                  return this.datastore.getDoctorList().then(doctorList => {
  ...
  function srcAppHomeHttPServiceHttpServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let HttpService = class HttpService {
      ...
      createPatient(newPatient) {
        ...
        return this.http.post(url, newPatient, this.httpOptions); // .toPromise()
        // .then(data => {
        //   console.log("da5lr")
        //   console.log(data);
        // }).catch(error => {
      ...
      PostVitals(vital, id) {
        ...
        console.log("URL", Url);
        return this.http.post(Url, vital, this.httpOptions);
      }
      ...
      PutVital(vital, id) {
        ...
        console.log("URL", Url);
        return this.http.put(Url, Svital, this.httpOptions);
      }
  ...
  /***/
  function srcAppModelDoctorDataTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "doctorData", function () {
      return doctorData;
    });
    /* harmony import */
  ...
  function srcAppModelPatientDataTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "MyPatient", function () {
      return MyPatient;
    });
    /* harmony import */
          ...
          return regeneratorRuntime.wrap(function _callee3$(_context3) {
            while (1) switch (_context3.prev = _context3.next) {
              case 0:
                ...
                that = this;
                _context3.next = 5;
                return this.getPatientToken().then(token => {
                  if (token != null) {
  ...
  function srcAppServicesDatastreamDatastreamingServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_model_patientData__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/model/patientData */
    "./src/app/model/patientData.ts");
    /* harmony import */


    var _datastorage_datastorage_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../datastorage/datastorage.service */
    "./src/app/services/datastorage/datastorage.service.ts");
    /* harmony import */


    var src_app_model_doctorData__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! src/app/model/doctorData */
    "./src/app/model/doctorData.ts");
    ...
    let DatastreamingService = class DatastreamingService {
      ...
      constructor(dataStore) {
        this.dataStore = dataStore;
        this.patient = new src_app_model_patientData__WEBPACK_IMPORTED_MODULE_2__["MyPatient"]();
      ...
      addToDoctorList(doc) {
        const doctor = new src_app_model_doctorData__WEBPACK_IMPORTED_MODULE_4__["doctorData"]();
      ...
      restoreStreamDatalist(doctorList) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0,
        /*#__PURE__*/
      ...
      SetPatientforLogin(patientData) {
        ...
        this.patient.password = patientData.password, this.patient.type = patientData.type;
      ...
      setPatient(patientData) {
        ...
        this.patient.password = patientData.user.password, this.patient.type = patientData.user.type;
    ...
    DatastreamingService.ctorParameters = () => [{
      type: _datastorage_datastorage_service__WEBPACK_IMPORTED_MODULE_3__["DatastorageService"]
    }];
    ...
    DatastreamingService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_datastorage_datastorage_service__WEBPACK_IMPORTED_MODULE_3__["DatastorageService"]])], DatastreamingService);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/habiba/GP/Graduation-Project-/Patient/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
